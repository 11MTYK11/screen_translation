...
runname = "Screen_Ocr.exe"
installpath = "\\Screen_OCR"
dlurl = "https://drive.google.com/u/0/uc?id=1qiBXkXLILUVPNrMC7-YEdA93T2NNQ92n&export=download"
lnkname = "画面翻訳君.lnk"
menuname = "画面翻訳君"
lnkcomment = "画面翻訳君"
uninstallname = "画面翻訳君"
        ...
        if str(userselect) == "1":
            if os.path.exists(DST):
                with tempfile.TemporaryDirectory() as tmpdir:
                    ...
                    DST = localpath + installpath
                    url = dlurl
                    if dltype ==  "google_drive":
                        gdl.download(url,downloadpath)
                    else:
